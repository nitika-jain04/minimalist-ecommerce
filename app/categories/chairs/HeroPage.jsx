    ...
    <div className="px-5 xl:px-36">
      <div className="flex justify-between items-center mt-14">
        <div className="flex items-center">
          ...
          <Link className="text-base styles.blinker font-medium" href="/">
            Home
          </Link>
        </div>

        <div className="w-full text-center">
          <h1 className="font-bold text-2xl styles.blinker">CHAIRS</h1>
        </div>
      </div>
    ...
    <Link href={`/categories/product/${id}`}>
      <article className="w-auto border-2 pt-5 pb-3 border-gray-300 hover:border-black hover:border-2 transition-all duration-300 ease-in-out">
        ...
        <div className="flex flex-col gap-2 pl-3">
          <p classNam="styles.blinker text-[17px] tracking-wide md:w-auto">
            {name}
          </p>
